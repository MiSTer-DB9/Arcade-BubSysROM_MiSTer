...
UPSTREAM_REPO="https://github.com/MiSTer-devel/Arcade-BubSysROM_MiSTer.git"
CORE_NAME=(Arcade-BubSysROM)
...
UPSTREAM_CORE_NAME=(Arcade-BubSysROM)
MAIN_BRANCH="main"
UPSTREAM_BRANCH="main"
COMPILATION_INPUT=(BubSysROM.qpf)
COMPILATION_OUTPUT=(output_files/BubSysROM.rbf)
